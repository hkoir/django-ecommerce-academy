...
class RegistrationForm(forms.ModelForm):
    ...
    #     label='Choose account type', choices=[('admin', 'Admin'), ('staff', 'Staff'), ('seller', 'Seller'),('general', 'General')],
    #     help_text='Required'
    # )
    ...
    class Meta:
        model = Customer
        fields = ('name', 'email', 'user_type', 'profile_picture')
    ...
    def clean_user_type(self):
        ...
        if Customer.objects.filter(user_type=user_type).exists():
            raise forms.ValidationError("User type already exists")
        return user_type
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['user_type'].widget.attrs.update(
            {'class': 'form-control mb-3', 'placeholder': 'Usertype'})
